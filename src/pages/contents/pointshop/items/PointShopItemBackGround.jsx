...
const PointShopItemBackground = () => {
    ...
    const paginatedItems = items.filter(item => item.itemType === "배경").slice(
        (currentPage - 1) * 24,
        currentPage * 24
    );
    ...
    return (
        ...
        <S.PaginationWrapper>
            ...
            totalPages={Math.ceil(items.filter(item => item.itemType === "배경").length / 24)}
...
export default PointShopItemBackground;